...
public class CreditsActivity extends AppCompatActivity {
    ...
    String URL_TO_PHP = "http://tollapi.000webhostapp.com/balance.php";
    ...
    class testing extends AsyncTask<Void,Void,String>{
        ...
        public String doInBackground(Void... args){
            HashMap<String , String> postDataParams = new HashMap<String, String>();
            postDataParams.put("cnic", preferenceHelper.getCnic());
            performPostCall("http://tollapi.000webhostapp.com/balance.php", postDataParams);
            n = performPostCall("http://tollapi.000webhostapp.com/balance.php", postDataParams);
        ...
        protected void onPostExecute(String aVoid) {
            ...
            preferenceHelper.putCredits(b);
            txt.setText(preferenceHelper.getCredits()+" "+"PKR");
